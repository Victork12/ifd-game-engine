...
class IFDParser{
	...
	void tokenIt(){
		...
		char c;
	   	...
	   	if(!inFile.is_open()){
	   		cout << "Error: could not open game file \"" << gameFile << "\"." << endl;
	   		cout << "Make sure the file exists and you typed the correct path relative to" << endl;
	   		cout << "the folder you ran this program from." << endl;
	   		exit(1);
	   	}
